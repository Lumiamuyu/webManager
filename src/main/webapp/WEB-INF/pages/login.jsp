...
<div class="signup__container">
    <div class="container__child signup__thumbnail">
        <div class="thumbnail__logo">
            ...
            <h1 class="logo__text">Login</h1>
        </div>
        <div class="thumbnail__content text-center">
            <h1 class="heading--primary">欢迎.</h1>
            <h2 class="heading--secondary">Wo Shi Zai Bu Zhi Dao Xie Dian Sha.</h2>
        </div>
        ...
        <form action="#">
            ...
            <div class="m-t-lg">
                <ul class="list-inline">
                    <li>
                        <input class="btn btn--form" type="submit" value="登录" />
                    </li>
                    <li>
                        <a class="signup__link" href="register">没有账号？请注册</a>
                    </li>
                </ul>
            </div>
        </form>
