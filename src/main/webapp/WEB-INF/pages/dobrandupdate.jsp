...
<main>
    ...
    <div>
        <form action="doBrandUpdate">
            <input type="text" hidden="hidden" name="id" value="${b.brandId}">
            商品名称<input class='required' name="name" placeholder='品牌名称' type='text' value="${b.brandName}">

            <div id='br'>
                商品描述<input class='required' name="des" placeholder='品牌描述' value="${b.brandDes}" type='text'>
            </div>
