...
<main>
    ...
    <div>
        <form action="doUpdate">
            ...
            商品名称<input class='required' name="name" placeholder='商品名称' type='text' value="${p.productName}">

            <div id='br'>
                商品价格<input class='required' name="price" placeholder='商品价格' type='text' value="${p.price}">
            </div>
            <div id='br'>
                商品图片<input name="url" placeholder='商品图片' type='file' value="${p.url}" onchange="imgChange(this)"><img id="img" width="150">
            </div>
            <div id='br'>
                商品描述<input class='required' name="des" placeholder='商品描述' value="${p.productDes}" type='text'>
            </div>
            <div id='br'>
                商品库存<input class='required' name="reverse" placeholder='商品库存' value="${p.reverse}" type='text'>
            </div>
